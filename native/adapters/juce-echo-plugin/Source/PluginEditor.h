...
private:
    ...
    juce::Label delayLabel_, feedbackLabel_, mixLabel_, lowCutLabel_, highCutLabel_;
    juce::Label saturationLabel_, rateLabel_, depthLabel_;
    juce::Slider delay_, feedback_, mix_, lowCut_, highCut_, saturation_, rate_, depth_;
    ...
    std::unique_ptr<SliderAttachment> delayAttachment_, feedbackAttachment_, mixAttachment_;
