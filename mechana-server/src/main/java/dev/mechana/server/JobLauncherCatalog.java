	...
	private static List<JobLauncherDescriptor> definitions() {
		...
		return List.of(
				...
				descriptor("audio-convolution-reverb", "Convolution reverb", "/api/jobs/audio-reverb", serverFiles,
						"Pure-Java convolution; dry audio is converted to the IR sample rate before staging",
						commonStorage("server-local"),
						file("dryPath", "Dry audio", "", "wav", "wave", "m4a", "aac", "mp4", "aif", "aiff"),
						...
						decimal("earlyLevel", "Early reflections level (0–2)", "1", 0, 2),
						decimal("lateLevel", "Late tail level (0–2)", "1", 0, 2),
						decimal("attackMilliseconds", "Captured-response attack (ms)", "0", 0, 5000),
						decimal("decayLengthPercent", "Captured decay length (%)", "100", 1, 100),
